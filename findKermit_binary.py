...
#this script assumes models, which output a binary decision: 0 Kermit present, 1 he is not
...
def ishethere(start,end,video):
    ...
    max_value_images = 1-np.min(y_pred)#0 Kermit present, 1 he is not
    ...
    max_value_audio = 1 - np.min(y_pred)#0 Kermit present, 1 he is not
    #data type for output
...
print(ishethere(0,5,'Muppets-02-04-04'))
